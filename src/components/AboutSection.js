      ...
      <>
        ...
        <div className="about-section-1">
          ...
          <ol className="about-section-paragraph-list">
            ...
            <li>
              <span className="about-blue">iii</span> &nbsp;BlueSense Learning
              is at our core and helps you effectively build a competitive team
          ...
          <p className="about-section-paragraph-2">
            Our mission is to help build the next generation of top tier
          ...
          <ol className="about-section-paragraph-2">
            <li>
              ...
              thinking. We have a robust history of simplifying challenges for
              our clientele.
            </li>
            <li>
          ...
          <p className="about-section-paragraph-3">
            Africa is becoming the next hub for companies + innovation; we want
            to be the go to consulting firm for companies in the continent - for
        ...
        <div className="about-section-2">
          ...
          <p>
            ...
            and emerging technology, allows us to address problems in unique
          ...
          <p>
            ...
            their set goals. Our clients are fully involved in the processes
            since we provide personalised solutions to the problems.
          </p>
          <br></br>
          <p>
            We have an enhanced capacity to implement change, build capacity,
            and help organisations transform themselves. Combining the full
            scope of our offer today with the strengths of our clients will
            spark and drive effective and long lasting change.
          </p>
        </div>
      </>
    );
