...
function LearningSection() {
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="BlueSense learning brings together expertise in technology, management, design, strategy, organisation, and analytics to help clients reinvent themselves. "/>
      </Helmet>
      ...
      <div className='learning-container'>
        ...
        <div className='learning1-body-2'>
          <p>
            We understand the importance of creating seamless and simple
            customer experiences. To deliver on that, we involve customers at
            every point of the process to understand what matters most to them
            through industry expertise, commercial insights, and analytical
            rigor.
          </p>
          <p>
          ...
          <p>
            Our talent and tools enable us to quickly invent, prototype, launch,
            and scale new concepts for our clients. We do this in ways that are
            collaborative, agile, and focused on driving sustained{" "}
            <span className='blue'>growth.</span>
          </p>
        </div>
      </div>
      ...
      <div className='learning-container-2'>
        ...
        <div className='learning2-body-div'>
          <p className='blue-learning'>
            Organisations using<br></br>
            Bluesense Learning training curriculums
          </p>
        </div>
        ...
        <div className='button-learning-2'>
          <button className='big-learning-button-2'>
            <Link to='/contact' className='big-learning-btn-link'>
              Schedule Consultation <i class='fas fa-caret-right'></i>
            </Link>
          </button>
        </div>
